...
For each approved slice, create a GitHub issue using `gh issue create`. Use the issue body template below. Create issues in dependency order (blockers first) so you can reference real issue numbers in the "Blocked by" field.
...
_Source: https://github.com/mattpocock/skills/tree/main/to-issues_
